...
enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .zhHans: [
            ...
            "touch_bar_content_automatic": "自动（单一服务）", "touch_bar_content_both": "同时显示 Codex 与 Claude",
            ...
            "error_http_status": "Claude 返回了错误（状态码 %d）。", "error_network": "网络错误：%@",
        ...
        .zhHant: [
            ...
            "touch_bar_content_automatic": "自動（單一服務）", "touch_bar_content_both": "同時顯示 Codex 與 Claude",
            ...
            "error_http_status": "Claude 傳回了錯誤（狀態碼 %d）。", "error_network": "網路錯誤：%@",
        ...
        .english: [
            ...
            "touch_bar_content_automatic": "One provider (automatic)", "touch_bar_content_both": "Codex and Claude together",
            ...
            "error_http_status": "Claude returned an error (status %d).", "error_network": "Network error: %@",
        ...
        .japanese: [
            ...
            "touch_bar_content_automatic": "自動（1件のみ）", "touch_bar_content_both": "Codex と Claude を同時表示",
            ...
            "error_http_status": "Claude がエラーを返しました（ステータス %d）。", "error_network": "ネットワークエラー：%@",
        ...
        .korean: [
            ...
            "touch_bar_content_automatic": "자동(단일 서비스)", "touch_bar_content_both": "Codex와 Claude 동시 표시",
            ...
            "error_http_status": "Claude가 오류를 반환했습니다(상태 코드 %d).", "error_network": "네트워크 오류: %@",
        ...
        .spanish: [
            ...
            "touch_bar_content_automatic": "Automático (un servicio)", "touch_bar_content_both": "Codex y Claude juntos",
            ...
            "error_http_status": "Claude devolvió un error (código %d).", "error_network": "Error de red: %@",
